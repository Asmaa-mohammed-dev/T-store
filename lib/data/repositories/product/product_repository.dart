...
Future<List<ProductModel>> getProductsForCategory({
  ...
  try {
    print('FETCH ProductCategory WHERE categoryId == $categoryId');
    ...
    print('ProductCategory count => ${productCategoryQuery.docs.length}');

    if (productCategoryQuery.docs.isEmpty) {
      print('❌ No Productcategory records found');
      return [];
    }

    final productIds = productCategoryQuery.docs
        .map((doc) => doc['productId'].toString().trim())
        .toList();
    ...
    print('Products found => ${productsQuery.docs.length}');
